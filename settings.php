        ...
        <div id="page-wrapper">
				...
				<div class="row">
					...
					<div class="col-lg-7">
						...
						<button type="button" onclick="closeAccountWarning();" class="btn btn-danger btn-block" style="margin-bottom:20px;">Close account</button>
					</div>
					<!-- /.col-lg-7 -->
					<div class="col-lg-5">
	...
	<script>	
		...
		function closeAccountWarning() {
			showBSModal({
				...
				body: '<div class="text-center"><b>Are you sure you want to delete this account?</b><br /><br /><span style="font-weight:700;color:red;">If you didn\'t save your SEED, and you have funds on this account, they will be lost forever!</span></div>',
				size: "small",
				actions: [{
