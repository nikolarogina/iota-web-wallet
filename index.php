			...
			<div class="modal-content text-center">
				<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" id="finish-login" >
					...
					<div class="modal-body text-center">
						...
						<label>Please enter your desired PIN number (4 digits).<br /> Your SEED is encrypted with PIN and saved in <a href="https://www.w3schools.com/html/html5_webstorage.asp" target="_blank">HTML5 Session Storage</a>. <br /><span style="color:red">You will be asked for this PIN for any important action!</span></label>
							<div id="pin-div">
	...
	<div class="modal fade" id="qr-scanner-modal" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content text-center">
				<div class="modal-header">
					<button type="button" id="modal-close-x" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					<h4 class="modal-title text-center">Scan IOTA seed</h4>
				</div>
            ...
            <div class="col-md-4 col-md-offset-4">
                ...
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
						...
						?>
						<div id="webgl2-error" style="display:none;" class="alert alert-danger text-center">This web wallet requires you to have a <b>WebGL2 supported browser</b>!<br /><a href="http://caniuse.com/#search=webgl%202" target="_blank">Click here to see on which browser you should upgrade!</a></div>
								...
								<div id="login-seed" style="display:none;">
									...
									<div class="form-group text-center">
										<label class="checkbox-inline">
											<input type="checkbox" id="enable-pin"> Enable PIN
										</label>
									</div>
									-->
								</div>
	...
	<script>
		...
		function webgl2Support() { 
			try {
				...
				return !! window.WebGLRenderingContext && (canvas.getContext('webgl2') || canvas.getContext('experimental-webgl2'));
			}
